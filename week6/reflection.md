...
## [Task4](https://github.com/AboMeezO/jordan-dev-v2/commit/b4dd6691b824d726544cc7efdff1b6504471b977)
Trying to use Vale on the same repo of week5 I figured that the docs are trash in terms of human language errors, it was like ✖ 269 errors, 27 warnings and 0 suggestions in 61 files :).
Note: I uploaded another commit just to remove the vale styles I uploaded by mistake.
Also note that the CI is failing since I didn't fix the issues in the code and docs.
